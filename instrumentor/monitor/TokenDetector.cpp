...
namespace {
  ...
  struct TokenDetector : public FunctionPass {
	...
	return false; // not the function we want to instrument
      ...
      Function * regOutToken = checkSanitizerInterfaceFunction(
	M.getOrInsertFunction("regOutToken", fIRB.getVoidTy(), 
