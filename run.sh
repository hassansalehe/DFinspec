...
make
cp *.so $BIN_DIR/
g++ -c -O3 -std=c++11 $INSTR_DIR/Logger.cpp -I$INSTR_DIR/../common -o $BIN_DIR/Logger.o  || { echo 'Compiling Logger.cpp failed' ; exit 1; }
g++ -c -O3 -std=c++11 $INSTR_DIR/Callbacks.cpp -I$INSTR_DIR/../common -o $BIN_DIR/Callbacks.o  || { echo 'Compiling Callbacks.cpp failed' ; exit 1; }
